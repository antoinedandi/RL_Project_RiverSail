...
class GridWorld_withWall(environments.discreteMDP.DiscreteMDP):
    ...
    def __init__(self, sizeX,sizeY, map_name="random", slippery=0.1,nbGoals=1,rewardStd=0.,density=0.2, lengthofwalks=5, initialSingleStateDistribution=False,seed=None):
        """
        ...
        if (map_name=="2-room"):
            ...
            self.maze = randomMap(sizeX, sizeY, density, lengthofwalks)
        ...
        super(GridWorld_withWall, self).__init__(self.nS, self.nA, P, R, isd,nameActions=self.nameActions,seed=None)
    ...
    def initRender(self):
        if (self.rendermode=='maze'):
            ...
            super(GridWorld_withWall, self).initRender()
...
class GridWorld(environments.discreteMDP.DiscreteMDP):
    ...
    def __init__(self, sizeX, sizeY, map_name="random", slippery=0.1, nbGoals=1, rewardStd=0., density=0.2,
                 lengthofwalks=5, initialSingleStateDistribution=False,seed=None):
        """
